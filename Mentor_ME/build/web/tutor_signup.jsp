<%-- 
    Document   : tutor_signup
    Created on : Apr 8, 2016, 8:38:11 AM
    Author     : shraddha
--%>
...
<html>
    ...
    <body>
        ...
        <div id ="container">
            ...
            <div id ="main">
                <div id ="center">
                    <center> <h1>Tutor Sign UP!!</h1></center>
...
<form action="" name="login" method="post">
                        ...
                        <table align="left" cellpadding="5" cellspacing="5" border="0">
                           ...
                           <tr>
                                <td width="50%" align="right"><b>Area of Interest :</b> </td>
                            ...
                            <tr>
                                <td colspan="2" align="right">
                                    ...
                                    <input type="submit" name="submit" title="Click To Login"  value="Sign UP!!"  />


                                    <input type="submit" name="signup" title="Click New User"  value="cancel"  />
                                </td>
                            </tr>
                        </table>
                    </form>                </div> 
