<%-- 
    Document   : Subject
    Created on : Apr 17, 2016, 9:52:25 AM
    Author     : shraddha
--%>
            ...
            <div id ="main">
                <div id ="center"
                    ...
                    <table align="center" cellpadding="5" cellspacing="5" width="90%" class="c" border="2">
                        <tr>
                            <th colspan="6"><font color="#000000" size="+3"><a href="" title="Click here to insert new record" > Subject Module</a> </font></th>
                        </tr>
                        <tr>
                            <th>Id</th>
                            <th>Subject</th>
                        ...
                        <%
                            while (rset.next()) {
                                ...
                                String subjectSpecification = rset.getString(3);
                                                      
                        %>
                        <tr>
                            <td><%= ID%></td>
                            <td><%= subjectName %></td>
                            <td><%= subjectSpecification %></td>
